...
return [
    ...
    'ruleNotFound'    => '{0} não é uma regra de validação válida.',
    'groupNotFound'   => '{0} não é um grupo de regras de validação.',
    'groupNotArray'   => '{0} o grupo de regras deve ser um array.',
    ...
    'alpha_numeric_punct'   => 'O campo {field} só pode conter caracteres alfanuméricos, espaços e ~ ! # $ % & * - _ + = | : . caracteres.',
    ...
    'differs'               => 'O campo {field} deve diferir do campo {param}.',
    ...
    'integer'               => 'O campo {field} deve conter um inteiro.',
    ...
    'is_not_unique'         => 'O campo {field} deve conter um valor pré-existente no banco de dados.',
    ...
    'valid_email'           => 'O campo {field} deve conter um endereço de email válido.',
    'valid_emails'          => 'O campo {field} deve conter todos os endereços de email válidos.',
    ...
    'max_size' => '{field} é muito grande para um arquivo.',
