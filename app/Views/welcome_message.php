...
<head>
    <meta charset="UTF-8">
    <title>Ecommece - CodeIgniter 4!</title>
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/clientes">Clientes</a></li>
            <li class="menu-item hidden"><a href="/pedidos">Pedidos</a></li>
        </ul>
    </div>

    <div class="heroe">

        <h1>Bem-vindo ao Curso Básico de CodeIgniter</h1>
        <h2>Ministrado por Danilo do Torne-se um Programador</h2>
...
<footer>
    <div class="environment">
        ...
        <p>Tempo de renderização {elapsed_time} segundos</p>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> Torne-se um programador - <a style="color:#fff" href="https://www.torneseumprogramador.com.br/cursos/desafio_php" target="_blank">link do curso</a></p>
